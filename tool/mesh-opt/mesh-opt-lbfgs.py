...
params_init = np.zeros(num_param)
...
def diff_render(vals, *args):
    ...
    if step == 0:
        ...
        write_coefficients(coeffs_path, vals)
    ...
    record_progress(os.path.join(step_dir, "record.csv"), params_target, params_init, vals, img_loss_rmse, param_loss_rmse)
